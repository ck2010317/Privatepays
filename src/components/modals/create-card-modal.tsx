...
const CARD_CREATION_FEE = 30;
const DEFAULT_INITIAL_TOPUP = 15;
...
export function CreateCardModal() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    phoneNumber: '',
    amount: DEFAULT_INITIAL_TOPUP.toString(),
  });
  ...
  const handleClose = () => {
    ...
    setCreatedCard(null);
    setFailureReason('');
    setFormData({ title: '', email: '', phoneNumber: '', amount: DEFAULT_INITIAL_TOPUP.toString() });
  };
  ...
  const totalUsd = CARD_CREATION_FEE + amount + topUpFee;
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-11 px-4 rounded-xl bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500 transition-all"
                />
                <p className="text-xs text-gray-500 mt-1">Minimum $10 - this will be your card&apos;s initial balance</p>
              </div>
              ...
              <div className="p-3 rounded-xl bg-yellow-500/10 border border-yellow-500/20">
                <p className="text-sm text-yellow-300">
                  💡 You&apos;ll pay with <strong>SOL</strong> on Solana blockchain. Send from a wallet holding the required tokens.
                </p>
              </div>
              ...
              <button
                type="submit"
                disabled={loading || !formData.title || !formData.email || !formData.phoneNumber || amount < 10}
                className={cn(
                  ...
                  (loading || !formData.title || !formData.email || !formData.phoneNumber || amount < 10)
          ...
          {step === 'failed' && (
            <div className="text-center py-6">
              ...
              <p className="text-gray-400 mb-4">
                {failureReason || 'Your payment was received but token verification failed.'}
              </p>
              
              <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-left mb-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full px-6 py-3 bg-gradient-to-r from-violet-500 to-purple-600 text-white rounded-xl font-medium hover:from-violet-600 hover:to-purple-700 transition-all"
                >
                  Try Again
                </button>
                <button
